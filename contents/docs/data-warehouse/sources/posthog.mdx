...
The `system.early_access_features` table contains [early access feature](/docs/feature-flags/early-access-feature-management) definitions from your project.
...
| `stage`            | Current stage: `draft`, `alpha`, `beta`, `general-availability`, or `archived` |
