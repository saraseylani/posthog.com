...
export const rbacSettingsLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_organization_light_5774d4da82.png";
export const rbacSettingsDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_organization_dark_a2f3786867.png";
export const projectAccessControlLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_project_light_b3afca7e77.png";
export const projectAccessControlDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_project_dark_d05334884e.png";
export const resourceAccessControlLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_resource_light_7ccb0f5311.png";
export const resourceAccessControlDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_resource_dark_aa8806bb1d.png";
export const objectAccessControlLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_object_light_864b64cfa3.png";
export const objectAccessControlDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/access_control_object_dark_17f1adda40.png";
