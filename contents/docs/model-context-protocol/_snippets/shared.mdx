...
**Prompt:** "Duplicate my 'support-assistant' prompt as 'support-assistant-v2'"

The agent will use the `prompt-duplicate` tool to copy the latest version of the source prompt to a new prompt with the specified name. This is useful for forking prompts or as a workaround for renaming since prompt names are immutable after creation.
