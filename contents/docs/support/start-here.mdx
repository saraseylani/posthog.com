...
Forward emails to PostHog to create support tickets automatically. Customers email your support address, and those messages become tickets in your inbox.

To set up email forwarding:

1. Enter your support email address and display name
2. Copy the forwarding address PostHog generates
3. Configure your email provider to forward emails

Replies are threaded automatically — if someone replies to an existing conversation, it's added to the same ticket.
