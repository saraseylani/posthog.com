...
- Set a `channel_detail` indicating how the ticket was created (`Channel message`, `Bot mention`, or `Emoji reaction`)
...
- The channel detail (e.g., "Channel message", "Bot mention", or "Emoji reaction")
- A link to the original Slack thread in the ticket sidebar
- The Slack user's name and avatar on messages

You can filter the ticket list by channel source or channel detail to see specific types of Slack tickets.
