...
| **Channel detail** | How the ticket was created within that channel (see below) |
...
### Channel detail values

Channel detail provides more granular information about how a ticket was created:

| Channel | Detail | Description |
|---------|--------|-------------|
| Slack | **Channel message** | Message posted in the configured support channel |
| Slack | **Bot mention** | Message mentioning `@SupportHog` |
| Slack | **Emoji reaction** | Ticket created via emoji reaction on a message |
| Widget | **Widget** | Created via the embedded chat widget |
| Widget | **API** | Created via the widget API directly |
...
- **Channel detail** – Filter by how tickets were created (e.g., bot mention, emoji reaction)
